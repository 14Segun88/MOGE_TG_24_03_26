...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
               ...
               <div align="center" style="width: 800px; position: absolute; left: 50%; margin-left: -400px;">
                    ...
                    <div class="frame">
                        ...
                        <table>
                            <tr>
                                ...
                                <td class="noborder">
                                    <p class="right">
                                        <xsl:value-of select="Signers/СhiefProjectEngineer/FamilyName"/>
                                        <xsl:text> </xsl:text>
                                        <xsl:value-of select="Signers/СhiefProjectEngineer/FirstName"/>
                                        <xsl:text> </xsl:text>
                                        <xsl:value-of select="Signers/СhiefProjectEngineer/SecondName"/>
                                    </p>
                                </td>
                            </tr>
                            
                            <xsl:if test="Signers/СhiefProjectArchitect">
                                <tr>
                                    <td class="noborder">
                                    ...
                                    <td class="noborder">
                                        <p class="right">
                                            <xsl:value-of select="Signers/СhiefProjectArchitect/FamilyName"/>
                                            <xsl:text> </xsl:text>
                                            <xsl:value-of select="Signers/СhiefProjectArchitect/FirstName"/>
                                            <xsl:text> </xsl:text>
                                            <xsl:value-of select="Signers/СhiefProjectArchitect/SecondName"/>
                                        </p>
                                    </td>
                                </tr>
                            </xsl:if>
                    ...
                    <table>
                        ...
                        <xsl:if test="ProjectInitialDocuments/Document[DocType &gt; '19.00' and DocType &lt; '20.00']">
                            <tr>
                                <td colspan="4" class="title">Специальные технические условия предусмотренные статьей 52.1 Градостроительного кодекса Российской Федерации и иными нормативными правовыми актами, документы о согласовании отступлений от положений специальных технических
                                    условий</td>
                            </tr>
                    ...
                    <xsl:if test="DesignerAssurance">
						...
						<tr>
                                ...
                                <td class="noborder">
									...
									<xsl:if test="Signers/СhiefProjectEngineer/NOPRIZ">
										<span class="smaller">Идентификационный номер<br/>в Национальном реестре специалистов<br/>НОПРИЗ - <xsl:value-of select="Signers/СhiefProjectEngineer/NOPRIZ"/></span>
									</xsl:if>
										</p>
                                </td>
                            </tr>
                            ...
                            <xsl:if test="Signers/СhiefProjectArchitect">
                                <tr>
                                    ...
                                    <td class="noborder">
										...
										<br/>
										<xsl:if test="Signers/СhiefProjectArchitect/NOPRIZ">
										<span class="smaller">Идентификационный номер<br/>в Национальном реестре специалистов<br/>НОПРИЗ - <xsl:value-of select="Signers/СhiefProjectArchitect/NOPRIZ"/></span>
										</xsl:if>
										</p>
                                    </td>
                                </tr>
    ...
    <xsl:template name="ProjectDocumentTableLine">
        ...
        <xsl:variable name="FileNumber">
            <xsl:if test="$Document/IULFile"><xsl:value-of select="count($Document/IULFile)+ count($Document/IULFile/SignFile) +1+ count($Document/File) + count($Document/File/SignFile)"/></xsl:if>
            <xsl:if test="not($Document/IULFile)"><xsl:value-of select="count($Document/File) + count($Document/File/SignFile)"/></xsl:if>
        </xsl:variable>
                ...
                <xsl:if test="position() = 1">
                    ...
                    <td style="width: 50%;">
                        ...
                        <xsl:if test="$Document/ProjectDocParticipants/ProjectDocParticipant[@role='Согласование']">
                            <br/>Согласование:<br/>
                            <xsl:for-each select="$Document/ProjectDocParticipants/ProjectDocParticipant[@role='Согласование']">
        ...
        <xsl:if test="$Functions/FunctionsClass">
            <p>
                <span class="field">Функциональное назначение по классификатору объектов капитального строительства по их назначению и функционально-технологическим особенностям (для целей архитектурно-строительного проектирования и ведения единого государственного реестра заключений экспертизы
                    проектной документации объектов капитального строительства): </span>
        ...
        <xsl:if test="FunctionsClass">
            <p>
                <span class="field">Функциональное назначение по классификатору объектов капитального строительства по их назначению и функционально-технологическим особенностям (для целей архитектурно-строительного проектирования и ведения единого государственного реестра
                    заключений экспертизы проектной документации объектов капитального строительства): </span>
    ...
    <xsl:template name="PrintDangerousAndComplexObject">
        ...
        <p>Объект относится к категории особо опасных и технически сложных объектов в соответствии с пунктом 
          <xsl:choose>
           ...
           части 1 статьи 48.1 Градостроительного кодекса Российской Федерации:</p> 
        <p>
            <xsl:choose>
