...
# Styles - fontColor and strokeColor removed from non-filled elements to auto-adapt to dark/light theme
...
s_text = "text;html=1;align=center;verticalAlign=middle;resizable=0;points=[];autosize=1;strokeColor=none;fillColor=none;"
s_dash_cont = "rounded=0;whiteSpace=wrap;html=1;fillColor=none;dashed=1;"
...
# Edges for structure (no strokeColor=#000000 so they auto adapt to dark mode)
s_edge_arr = "edgeStyle=orthogonalEdgeStyle;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;endArrow=classic;endFill=1;"
s_edge_line = "edgeStyle=orthogonalEdgeStyle;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;endArrow=none;endFill=0;"
...
add_edge(root1, "e8", "n_zam", "n_vhod", "edgeStyle=orthogonalEdgeStyle;rounded=0;html=1;endArrow=classic;endFill=1;", [[1400, 130]])
...
add_edge(root1, "e27", "n_t_mod2", "n_db", s_edge_arr, [[200, 535], [200, 700]])
add_edge(root1, "e28", "n_llm", "n_db", "edgeStyle=orthogonalEdgeStyle;rounded=0;html=1;endArrow=classic;endFill=1;startArrow=classic;startFill=1;")
add_edge(root1, "e29", "n_soot", "n_llm", s_edge_arr)

add_edge(root1, "e30", "n_soot", "n_tech", s_edge_arr)
add_edge(root1, "e31", "t_prompt", "n_llm", s_edge_arr)
add_edge(root1, "e32", "t_user", "n_llm", s_edge_arr)
...
def add_rect(root, id, val, x, y, w, h, fill, font="#000000", align="left"):
    style = f"rounded=0;whiteSpace=wrap;html=1;fillColor={fill};strokeColor=#000000;fontColor={font};fontFamily=Arial;fontSize=10;align={align};spacingLeft=5;"
...
# Removed explicit extra mxGeometry logic, used align="center" param to incorporate into styles
add_rect(root2, "hdr_komp", "Проверка комплектности томов ПД", 230, y_offset, 340, 40, "#ffffff", "#000000", align="center")
y_offset += 40
...
# Removed explicit extra mxGeometry logic
add_rect(root2, "hdr_zayv", "Заявление на проведение экспертизы", 230, y_offset, 340, 40, "#ffffff", "#000000", align="center")
...
# Black boxes (made adaptive text for dark theme)
add_node(root2, "b_srv1", "Данные от\nстороннего сервиса", 620, 520, 100, 40, "rounded=0;whiteSpace=wrap;html=1;fillColor=#1a1a1a;strokeColor=#ffffff;fontColor=#ffffff;fontFamily=Arial;fontSize=10;")
add_node(root2, "b_srv2", "Данные от\nстороннего сервиса", 620, 580, 100, 40, "rounded=0;whiteSpace=wrap;html=1;fillColor=#1a1a1a;strokeColor=#ffffff;fontColor=#ffffff;fontFamily=Arial;fontSize=10;")

# Edges for pipeline
s_edge_p = "edgeStyle=orthogonalEdgeStyle;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;endArrow=classic;endFill=1;"

add_edge(root2, "e_v_l", "p_vhod", "l_1_t", s_edge_p, [[150, 510], [150, 280]])

# from left 1 to right Blues
add_edge(root2, "eb1", "l_1_t", "r_16-20_n", s_edge_p, [[600, 280], [600, 140]])

# from left 3 to right 106
add_edge(root2, "eb2", "l_3_t", "r_106_n", s_edge_p, [[600, 340], [600, 890]])

# 72 to black boxes
add_edge(root2, "eb3", "l_72_t", "b_srv1", s_edge_p, [[590, 600], [590, 540]])
add_edge(root2, "eb4", "l_72_t", "b_srv2", s_edge_p, [[590, 600], [590, 600]])
add_edge(root2, "eb5", "b_srv1", "r_66_n", s_edge_p, [[740, 540], [740, 500]])
add_edge(root2, "eb6", "b_srv2", "r_67_n", s_edge_p, [[740, 600], [740, 560]])
